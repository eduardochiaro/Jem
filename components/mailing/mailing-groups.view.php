...
<div id="bordo"> <!--inizio #bordo-->
     	...
     	<h2 class="titolo">Gestione Gruppi Iscritti</h2>
...
<?php echo Forms::button("avvia ricerca","submit",'pulsante-invia')?>
	...
	<?php echo Forms::hidden("t",$task)?>
            ...
            <div id="inserisci-elemento">
            	...
            	<a href="<?php echo Utils::makeLink($module,"newGroup")?>" title="">inserisci gruppo</a>
...
<td class="small">
		<?php echo Utils::href(Utils::makeLink($module,"openGroup",array("id"=>$row->id)),'modifica',array("class"=>"button"));?>
		</td>

    <td class="small ultimo">
    <?php 
        echo Utils::href(Utils::makeLink($module,"deleteGroup",array("id"=>$row->id)),"cancella",array("onclick"=>'return confirm(\'Sei sicuro di voler eliminare questo elemento?\')',"class"=>"button red"));
    ?>
    </td>
</tr>
<?php endforeach;?>
