...
class contentsController extends Controller{
	...
	function execNew(){
		...
		$workspace->set("contacts_system",$parameters->contacts);
		$workspace->set("photo_system",$parameters->videogallery);
		$workspace->set("video_system",$parameters->photogallery);
	...
	function execSave(){
		...
		if($post["contacts"]){
			$parameters["contacts"] = $post["contacts"];
		}
