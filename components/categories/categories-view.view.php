...
$actualModel = $workspace->getRequest("model");
...
<div id="bordo"> <!--inizio #bordo-->
     	...
     	<h2 class="titolo">Gestione Categorie - <?php echo $toModel->$actualModel?></h2>
...
<?php echo Forms::button("avvia ricerca","submit",'pulsante-invia')?>
	...
	<?php echo Forms::hidden("t",$task)?>
            ...
            <div id="inserisci-elemento">
            	...
            	<a href="<?php echo Utils::makeLink($module,"new",array("model"=>$workspace->getRequest("model")))?>" title="">inserisci categoria</a>
